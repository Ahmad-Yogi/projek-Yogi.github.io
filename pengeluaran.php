...
require_once('koneksi.php');
	...
	if (!empty($_POST['Tanggal'])) {
		...
		$sql='INSERT INTO laporankeuangan (Tanggal,Pengeluaran,Keterangan_Pengeluaran)VALUES(?,?,?)';
			...
			<div class="col-lg-6">
				<form action="" method="POST">
					...
					<div class="form-group">
						...
						<input type="number" value="" placeholder="Masukan Jumlah Pengeluaran" class="form-control" name="Pengeluaran">
					</div>
					<div class="form-group">
						<label>Keterangan</label>
						<input type="text" value="" placeholder="Masukan Keterangan" class="form-control" name="Keterangan_Pengeluaran">
					</div>
